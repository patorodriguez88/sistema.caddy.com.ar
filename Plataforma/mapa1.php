...
$sql=mysql_query("SELECT Patente,NombreChofer FROM Logistica WHERE Recorrido='$Recorrido' AND Eliminado=0");
...
echo '<markers>';
$query=mysql_query("SELECT * FROM HojaDeRuta WHERE Seguimiento='$CodigoSeguimiento' AND Estado='Abierto' AND Eliminado='0' ORDER BY Posicion ASC");	  
