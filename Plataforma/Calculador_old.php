...
//          document.getElementById('endnumero').style.display='block';
         ...
         window.location='https://www.caddy.com.ar/SistemaTriangular/Plataforma/MisClientes.php?Agregar=Cliente';
          ...
          document.getElementById('domicilio').value=dir[7];  
...
if($Dato[Direccion]==''){
   ...
   <div id="right-panel">
    <div id="lateral" style="width:50%;margin-left:0px;float:left;">
      ...
      <form class="login" method="POST" action="" style='margin-top:10px;height:80%' >
...
<?  
  ...
  echo "<option  value='$Servicios[PrecioPlano],$Nombre[Titulo],$RestriccionLocalidad,$Servicios[MaxKm],$Servicios[PrecioPlano]'>$Nombre[Titulo] $Nombre[Descripcion] $Servicios[MaxKm] ( $ $Servicios[PrecioPlano])</option>";  
  }
...
//               summaryPanel.innerHTML += route.legs[i].duration.text + '<br><br>';
            ...
            var txtdimensiones='';  
//             var dimen=document.getElementById('resultado').innerText;  
...
//             }else{
//             alert("Los km "+res+" entre el Origen y el Destino superan el maximo de la tarifa, seleccione otra tarifa");
//             document.location.href = "Calculador_p.php";
//             }
