...
(CASE WHEN TransClientes.FormaDePago = 'Origen' THEN TransClientes.IngBrutosOrigen ELSE TransClientes.idClienteDestino END) = Clientes.id WHERE Fecha = CURRENT_DATE() AND Clientes.user_id <> '' AND TransClientes.Eliminado =0;");
