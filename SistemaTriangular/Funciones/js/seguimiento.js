    ...
    success: function (response) {
      ...
      if (jsonData.success == 1) {
        $("#myCenterModalLabel").html(
          "Seguimiento de Codigo " + id + " Visitas: " + jsonData.Visitas,
        );
      }
    },
  });
    ...
    success: function (response) {
      ...
      $("#info_guia_seguimiento").html(
        "<tbody>" +
          ...
          "</tr>" +
          "<tr>" +
          '<th>Observaciones:</th><td colspan="3">' +
