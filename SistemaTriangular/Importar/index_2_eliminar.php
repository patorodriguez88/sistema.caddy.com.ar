...
require_once('vendor/SpreadsheetReader_CSV.php');

if (isset($_POST["import"]))
{

$allowedFileType = ['application/vnd.ms-excel','text/csv','text/xls','text/xlsx','application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'];
        ...
        for($i=0;$i<$sheetCount;$i++)
        {
            ...
            foreach ($Reader as $Row)
            {
                ...
                if (!empty($idProveedor)) {
                    ...
                    $sqlclientes=mysqli_query($con,$query);
                      ...
                      <div class="col-12 col-md-12"> 
                        ...
                        <div class="card-body" id="outer">
                          ...
                          <form class="col-12 col-md-12" action="" method="post" name="frmExcelImport" id="frmExcelImport" enctype="multipart/form-data">
                              ...
                              <div>
                                  <label>Elija Archivo Excel</label> <input type="file" name="file" id="file">
