                                        ...
                                        <h4 class="header-title mb-3">Salidas con Fecha de Entrega Hoy</h4>
                                          <div class="accordion custom-accordion" id="custom-accordion-one">
                                              ...
                                              ?>
                                                ...
                                                <div class="card mb-0">
                                                      <div class="card-header" id="<?php echo $row[Recorrido];?>">
                                                          <h5 class="m-0">
                                                              <a class="custom-accordion-title d-block py-1"
                                                                ...
                                                                <i class="uil-location-point"></i> Rec.: <?php echo $row[Recorrido].' (Entregados '.$suma[Entregados].' de '.$suma[TotalServicios].')';?>
