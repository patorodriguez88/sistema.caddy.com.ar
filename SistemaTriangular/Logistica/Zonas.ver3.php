                        ...
                        <div class="row">
                           <div class="col-xl-4">
                                <div class="card">
                                    ...
                                    <div class="mt-3"><i class="mdi mdi-square-rounded" style="color:rgb(63,91,169)"></i><a><b>Zona 1:</b><i onclick="asignar_zona(1)" class="mdi mdi-alpha-r-box text-warning"></i><span val="" class="badge bg-warning rounded-pill 1"></span><b id="total_1"></b></a></div>
                                    <div><i class="mdi mdi-square-rounded" style="color:RGB(0,157,87)"></i><a><b>Zona 2: </b><i onclick="asignar_zona(2)" class="mdi mdi-alpha-r-box text-warning"></i><span class="badge bg-warning rounded-pill 2"></span><b id="total_2"></b></a></div>
                                    <!-- <i class="mdi mdi-square-rounded"></i> -->
                                    <div><i class="mdi mdi-square-rounded" style="color:RGB(166,27,74)"></i><b>Zona 3: </a></b><i onclick="asignar_zona(3)" class="mdi mdi-alpha-r-box text-warning"></i><span class="badge bg-warning rounded-pill 3"></span> <a><b id="total_3"></b></a></div>
                                    <div><i class="mdi mdi-square-rounded" style="color:RGB(0,157,87)"></i><b>Zona 4: </a></b><i onclick="asignar_zona(4)" class="mdi mdi-alpha-r-box text-warning"></i><span class="badge bg-warning rounded-pill 4"></span><a><b id="total_4"></b></a></div>
                                    <div><i class="mdi mdi-square-rounded" style="color:RGB(244,235,55)"></i><b>Zona 5: </a><i onclick="asignar_zona(5)" class="mdi mdi-alpha-r-box text-warning"></i><span class="badge bg-warning rounded-pill 5"></span></b><a><b id="total_5"></b></a></div>
                                    <div><i class="mdi mdi-square-rounded" style="color:RGB(124,53,146)"></i><b>Zona 6: </a><i onclick="asignar_zona(6)" class="mdi mdi-alpha-r-box text-warning"></i><span class="badge bg-warning rounded-pill 6"></span></b><a><b id="total_6"></b></a></div>
                                    <div><i class="mdi mdi-square-rounded" style="color:RGB(238,156,150)"></i><b>Zona 7: </a><i onclick="asignar_zona(7)" class="mdi mdi-alpha-r-box text-warning"></i><span class="badge bg-warning rounded-pill 7"></span></b><a><b id="total_7"></b></a></div>
                                    <div><i class="mdi mdi-square-rounded" style="color:RGB(121,80,70)"></i><b>Zona 8: </a></b><i onclick="asignar_zona(8)" class="mdi mdi-alpha-r-box text-warning"></i><span class="badge bg-warning rounded-pill 8"></span><a><b id="total_8"></b></a></div>
                                    <div><i class="mdi mdi-square-rounded" style="color:RGB(219,68,54)"></i><b>Zona 9: </a></b><i onclick="asignar_zona(9)" class="mdi mdi-alpha-r-box text-warning"></i><span class="badge bg-warning rounded-pill 9"></span><a><b id="total_9"></b></a></div>
                                    <div><i class="mdi mdi-square-rounded" style="color:RGB(147,215,232)"></i><b>Zona 10: </a></b><i onclick="asignar_zona(10)" class="mdi mdi-alpha-r-box text-warning"></i><span class="badge bg-warning rounded-pill 10"></span><a><b id="total_10"></b></a></div>
                                    <div><i class="mdi mdi-square-rounded" style="color:RGB(147,215,232)"></i><b>Zona 12: </a></b><i onclick="asignar_zona(12)" class="mdi mdi-alpha-r-box text-warning"></i><span class="badge bg-warning rounded-pill 10"></span><a><b id="total_12"></b></a></div>
