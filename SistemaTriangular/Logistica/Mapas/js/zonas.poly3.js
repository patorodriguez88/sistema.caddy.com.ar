...
initMap();
    ...
    //   zona = 12;
      ...
      $.ajax({
          data: {'Buscar_poly':1,'zona':12,'rec':selected},
          url:'Mapas/php/zonas.php',
          type:'post',
          success: function(response)
           {
            ...
            if (google.maps.geometry.poly.containsLocation(marker.getPosition(), rectanglem)) {
                ...
                if (zona == 12) {numero12 += 1;grup_zona12.push(idclientes);}  
                 ...
                 var total_zonas = numero1+numero2+numero3+numero4+numero5+numero6+numero7+numero8+numero9+numero10;
                        ...
                        $('#total_12').html(' '+numero12+' Clientes.');
    ...
    $.ajax({
        ...
        ' Moveremos '+grup_zona12.length+' servicios al Recorrido ' +$('.badge-pill.12').val()+'</br>'
        );
    });
    ...
    $('#renderizar_ok').click(function(){
        ...
        var rec12=$('.badge-pill.12').val();

        $.ajax({
        data:{'RecZona1':rec1,'RecZona2':rec2,'RecZona3':rec3,'RecZona4':rec4,'RecZona5':rec5,'RecZona6':rec6,'RecZona7':rec7,
        'RecZona8':rec8,'RecZona9':rec9,'RecZona10':rec10,'RecZona12':rec12,'Zona1':grup_zona1,'Zona2':grup_zona2,'Zona3':grup_zona3,'Zona4':grup_zona4,'Zona5':grup_zona5,
        'Zona6':grup_zona6,'Zona7':grup_zona7,'Zona8':grup_zona8,'Zona9':grup_zona9,'Zona10':grup_zona10,'Zona12':grup_zona12},
        type: "POST",
        url: "Mapas/php/zonas.php",
        beforeSend: function () {
