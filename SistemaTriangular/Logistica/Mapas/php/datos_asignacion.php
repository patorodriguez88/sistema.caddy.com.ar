...
$query="SELECT * FROM HojaDeRuta WHERE Estado='Abierto' AND Eliminado='0' LIMIT 0,10";	
...
$sql = mysql_query("SELECT count(id)as repe FROM TransClientes WHERE RazonSocial = '$dato[RazonSocial]' AND Retirado = 0 AND Entregado= 0 AND Recorrido='$row[Recorrido]' ");  
