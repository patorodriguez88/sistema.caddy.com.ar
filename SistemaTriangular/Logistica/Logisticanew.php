...
<body class="loading" data-layout="topnav" data-layout-config='{"layoutBoxed":false,"darkMode":false,"showRightSidebarOnStart": true}'>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 mt-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="numero_orden" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-12 mt-3">
                                        <div class="form-group">
                                            <label></label>
                                            <button id="cerrar_orden" type="submit" class="btn btn-primary float-right">Aceptar</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <script src="Proceso/js/logisticanew.js"></script>
            <!-- demo app -->
