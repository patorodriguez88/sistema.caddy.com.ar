...
//     $ruta = "../FacturasVenta/" . $NumeroComprobante.".".$extension;
    ...
    $ruta = "../".$_POST['carpeta']."/".$_FILES['imagen']['name'];
        ...
        if($_POST['carpeta']=='Presupuestos'){
        $newname="OP.".$_FILES['imagen']['type'];  
          $newname=explode(".",$_FILES["imagen"]["name"]);
          $newname2="OP".$_POST[id_o]."P".$_POST[id_p].".".$newname[1];
//           print $newname;
//           exit;
//         $ext=explode()  
