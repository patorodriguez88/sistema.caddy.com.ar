...
if(isset($_POST['Pendientes'])){
  ...
  $sql="SELECT TransClientes.*,NombreCuenta FROM TransClientes INNER JOIN PlanDeCuentas ON FormaDePago=Cuenta WHERE Haber>1 AND TransClientes.Eliminado=0 AND Fecha>='$_POST[Inicio]' AND Fecha<='$_POST[Final]'";
