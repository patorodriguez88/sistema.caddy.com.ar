...
$SumaAsiento="SELECT SUM(Debe-Haber)AS TotalAsiento FROM Tesoreria WHERE NumeroAsiento=$NAsiento AND Eliminado=1";
...
$Total=money_format('%i',$row[TotalAsiento]);
		...
		$sql=mysql_query("UPDATE Tesoreria SET Eliminado=0 WHERE NumeroAsiento='$NAsiento'");
