...
<html lang="en">
    ...
    <!-- <body class="loading" data-layout-config='{"leftSideBarTheme":"dark","layoutBoxed":false, "leftSidebarScrollable":false,"darkMode":false, "showRightSidebarOnStart": true}'> -->
    <body class="loading">    
    <!-- Begin page -->
        <div class="wrapper">
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <button id="mostrarSidebarBtn">Mostrar Sidebar</button>
        ...
        <!-- Right Sidebar -->
        <div class="right-bar" data-bs-toggle="tooltip">
        ...
        <script src="Procesos/js/control_billing.js"></script>
    </body>
</html>
