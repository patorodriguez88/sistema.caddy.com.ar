...
echo "<tr><td colspan='5' style='font-weight: bold;'>Observaciones: $dato[Cantidad] $titulo. $dato[Observaciones]</td></tr>";
echo "</table>";
echo "</div>";
echo "</div>";
echo "</div>";      
...
echo "</form>";
 ...
 $idfinal="'".$idCliente."'";
  ...
  $sqlBuscaCodigos=mysql_query("SELECT * FROM TransClientes WHERE IngBrutosOrigen IN($idfinal) 
...
//       $DestinoTotal=mysql_fetch_array($sqlTotal);  
    ...
    echo "<td style='padding:5px'>$Origen</td>";
    ...
    echo "<td style='padding:5px;font-size:12px'>$sqlResult[Estado] $Fecha1 $sqlResult[Hora]</td>"; 
