...
while($DATOS_CLIENTES=$SQL->fetch_array(MYSQLI_ASSOC)){
    //BUSCO TODAS LAS ORDENES
        ...
        CURLOPT_HTTPHEADER => array(
            ...
            //SI HAY ERROR DE CONEXION REFRESH TOKEN - logica centralizada en
            //meli_api.php (antes tenia el client_id/secret repetidos aca).
            if($http_code == 401){

            meliRefreshAccessToken($mysqli, (int)$DATOS_CLIENTES['id'], (string)$DATOS_CLIENTES['refresh_token']);
