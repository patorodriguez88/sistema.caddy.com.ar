...
<head>
    <meta charset="utf-8" />
    <title>Sistema Caddy | Cpanel 2</title>
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 order-lg-2 order-xl-1">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h4 class="header-title mt-2">REPARTIDORES | ENTREGAS MENSUALES </h4>
                                            <div class="table-responsive">
                                                <table class="table table-centered table-nowrap table-hover mb-0" id="desempeno_productividad">
                                                    <tbody>
                                                        <thead>
                                                            <tr>
                                                                <th>Nombre Completo</th>
                                ...
                                <div class="col-xl-12 col-lg-12 order-lg-2 order-xl-1" style="display:none" id="panel1">
                                    <div class="card">
                                        <div class="card-body">
                                ...
                                <div class="col-xl-6 col-lg-12 order-lg-2 order-xl-1" style="display:none" id="panel2">
                                    <div class="card">
                                        <div class="card-body">
                                            <!--                                         <a href="" class="btn btn-sm btn-link float-right mb-3">Export
                                            <i class="mdi mdi-download ml-1"></i>
                                        </a> -->
                                            <h4 id="" class="header-title mt-2">Desempeño Repartidores </h4>

                                            <div class="table-responsive">
                                                <table class="table table-centered table-nowrap table-hover mb-0" id="">
                                                    <tbody>
                                                        <thead>
                                                            <tr>
                                                                <th>Nombre Completo</th>
                                ...
                                <div class="col-xl-6 col-lg-12 order-lg-2 order-xl-1">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h4 id="desempeno1" class="header-title mt-2">Desempeño Repartidores </h4>

                                            <div class="table-responsive">
                                                <table class="table table-centered table-nowrap table-hover mb-0" id="basic">
                                                    <tbody>
                                                        <thead>
                                                            <tr>
                                                                <th>Nombre Completo</th>
                                ...
                                <div class="col-xl-6 col-lg-12 order-lg-2 order-xl-1">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h4 id="desempeno2" class="header-title mt-2">Desempeño Repartidores </h4>

                                            <div class="table-responsive">
                                                <table class="table table-centered table-nowrap table-hover mb-0" id="desempeno">
                                                    <tbody>
                                                        <thead>
                                                            <tr>
                                                                <th>Nombre Completo</th>
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title mb-3">Vehiculos Gestya</h4>
