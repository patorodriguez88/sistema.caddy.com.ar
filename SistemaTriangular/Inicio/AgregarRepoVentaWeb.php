...
//
// Motivo: Doble sin uso de Ventas/AgregarRepoVentaWeb.php (ese sí está vivo); usa mysql_query().
//
...
// disponible en el historial de git ("git log -- Inicio/AgregarRepoVentaWeb.php").
// ============================================================
