...
//   echo "<td>".$datoidproveedor[idProveedor]."</td>";
  ...
  echo "<td title='Recorrido'>".$fila[Recorrido]."</td>";
	...
	echo "<td align='center'><a target='_blank' href='/SistemaTriangular/Ventas/Informes/Remitopdf2.php?CS=".$fila[CodigoSeguimiento]."'><input type='image' src='../images/botones/Factura.png' width='15' height='15' border='0' style='float:center;'></td>";
	echo "<td align='center'><a target='_blank' href='/SistemaTriangular/Ventas/Informes/Rotulospdf.php?CS=".$fila[CodigoSeguimiento]."'><input type='image' src='../images/botones/mas.png' width='15' height='15' border='0' style='float:center;'></td>";
	echo "<td align='center'><a target='_blank' href='/SistemaTriangular/Servicios/Seguimiento.php?codigoseguimiento_t=".$fila[CodigoSeguimiento]."&Continuar=Buscar'><input type='image' src='../images/botones/zoom.png' width='15' height='15' border='0' style='float:center;'></td>";
