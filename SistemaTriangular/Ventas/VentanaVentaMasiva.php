...
//
// Motivo: Parte del flujo de Venta Masiva (ya deshabilitado en el menú); usa mysql_query().
//
...
// disponible en el historial de git ("git log -- Ventas/VentanaVentaMasiva.php").
// ============================================================
