...
//
// Motivo: Pantalla de Venta Masiva, deshabilitada en el menú (texto en rojo); usa mysql_query() desde la carga inicial.
//
...
// disponible en el historial de git ("git log -- Ventas/VentaMasiva.php").
// ============================================================
