    ...
    _googleAcDebounce(inputstart, {
        onSelect: function(place) {
            ...
            place.address_components.forEach(function(c) {
                var t = c.types[0];
                if (t === 'locality') document.getElementById('ciudad').value = c.long_name;
                else if (t === 'postal_code') document.getElementById('Codigo_Postal_t').value = c.long_name;
                else if (t === 'street_number') document.getElementById('numero').value = c.long_name;
                else if (t === 'route') document.getElementById('calle').value = c.long_name;
            });
        }
    });
}
