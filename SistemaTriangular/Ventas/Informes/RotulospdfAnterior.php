...
QRcode::png('http://www.caddy.com.ar/Seguimiento.php?codigo_t='.$fila['CodigoSeguimiento'], $filename, $errorCorrectionLevel, $matrixPointSize, 2); 
...
for ($i=1; $i<=$numfilas; $i++)
  ...
  $pdf->SetTextColor(0);
	...
	$pdf->SetWidths(array(15, 40, 15, 40));
...
//  	$pdf->Image('../../images/caddy.jpg',175 ,$b, 40 , 15,'jpg','');
  ...
  $pdf->SetTextColor(0);
	...
	$pdf->SetWidths(array(15, 40, 15, 80));
