$('#crearorigen').click(function(){
          ...
          success: function(response)
           {
              ...
              $("#errorname_label").html('Ya existen '+ jsonData.num + ' ' + n + ' cargados en el sistema, verifique !');
              }
           }  
      });   
    }
    ...
    var codigo=  getParameterByName('Repo');  
       window.open("https://www.caddy.com.ar/SistemaTriangular/Ventas/Informes/Remitopdf2.php?CS="+codigo, '_blank');
    });
    $('#terminar').click(function(){
       window.open("https://www.caddy.com.ar/SistemaTriangular/Ventas/Ventas_e.php",'_self');
    });
    ...
    function todoslosrec(){
        ...
        if(r==0){ // COMO ES RETIRO SELECCIONO EL ID DEL ORIGEN
            if(document.getElementById('id_origen').value==null){
          ...
          success: function(response)
           {
              ...
              if (jsonData.success == "1")
              {
              document.getElementById('origen_ok').style.display="inline";   
              if(jsonData.Direccion1!=''){
              document.getElementById('origen_ok_icon').style.display="inline"; 
              }
              
              document.getElementById('origen_ok').innerHTML="Direccion: "+jsonData.Direccion;  
            ...
            $.ajax({
                    ...
                    type: "POST",
                    url: "https://www.caddy.com.ar/SistemaTriangular/Funciones/php/tablas.php",
                    success: function(response)
                    {
          ...
          success: function(response)
           {
              ...
              if (jsonData.success == "1")
              {
               ...
               document.getElementById('destino_ok').innerHTML="Direccion: "+jsonData.Direccion;     
              }
            }  
      });
    ...
    //            document.getElementById('tercero_ok').style.display="block";  
               document.getElementById('tercero_ok').innerHTML="Direccion: "+jsonData.Direccion;     
              }
            }  
      });
    }
          ...
          // alert('enviando...');
            ...
            success: function (respuesta){
                    ...
                    var necesitosaber=document.getElementById('valorcrear').value;
                      ...
                      document.getElementById('nuevoclienteorigen2').style.display='block';
                      ...
                      document.getElementById('origen2_ok').innerHTML="Direccion: "+jsonData.Direccion;
                      oculto_origen(id)
