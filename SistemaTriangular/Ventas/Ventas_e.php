...
<head>
  ...
  <meta content="Ventas Simples Caddy" name="description" />
                  ...
                  <div class="row">
                    <div class="col-lg-4 mt-3">
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" data-provide="typeahead" id="valordeclarado_t" name="valordeclarado_t">
                      </div>
                    </div>
                    <div class="col-lg-4 mt-3">
                      <div class="mb-3">
                        <label>Alicuota Seguro</label>
                        <input type="text" class="form-control" data-provide="typeahead" id="alicuotaseguro_t" name="alicuotaseguro_t">
                      </div>
                    </div>
                    <div class="col-lg-4 mt-3">
                      <div class="mb-3">
                        <label>Valor Seguro</label>
                        <input type="text" class="form-control" data-provide="typeahead" id="valorseguro_t" name="valorseguro_t">
                      </div>
                    </div>
                  </div>
                  <div class="row">
