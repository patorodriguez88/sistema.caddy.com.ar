...
//
// Motivo: Único destino del formulario de Venta Masiva (menú deshabilitado en rojo); usa mysql_query().
//
...
// disponible en el historial de git ("git log -- Ventas/AgregarRepoVentaMasiva.php").
// ============================================================
