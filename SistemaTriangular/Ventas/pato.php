...
//
// Motivo: Sin ninguna referencia en el resto del sistema; usa mysql_query(), función eliminada de PHP hace años.
//
...
// disponible en el historial de git ("git log -- Ventas/pato.php").
// ============================================================
