...
//
// Motivo: Solo alcanzable desde el flujo de Venta Masiva (ya deshabilitado); usa mysql_query().
//
...
// disponible en el historial de git ("git log -- Ventas/ReposicionesEditar.php").
// ============================================================
