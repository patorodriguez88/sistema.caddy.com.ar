...
echo json_encode(array('data'=>1,'CAE'=>73233604518596,'VencimientoCAE'=>'2023-06-11','Numero'=>'00002-00000201'));
...
//   if($CondicionIva==1){ //RESPONSABLE INSCRIPTO FACTURA A

//   $Documento =preg_replace("/[^0-9]/", "", $_POST['documento_f']); 
  
//   }else if($CondicionIva==5){  // CONSUMIDOR FINAL FACTURA B

//   $Documento=0; 
//   }
//   //COMPROBANTE 1 RESPONSABLE INSCRIPTO 6 CONSUMIDOR FINAL
...
// echo json_encode(array('data'=>0,'error'=>$excepcion_capturada));
// }
