...
<body class="loading" data-layout="topnav" data-layout-config='{layoutBoxed":false,"darkMode":false}'>
    ...
    <div class="wrapper">
        <div class="content-page">
            <div class="content">
                ...
                <div id="badge_fecha_minima" class="alert alert-info mb-3"></div>

                <table id="seguimiento" class="table table-bordered table-sm">
                    <thead>
                        <tr>
                            <th>Fecha</th>
                            <th>Por Arribar</th>
                            <th>Proc. Preparación</th>
                            <th>Proc. Despacho</th>
                            <th>Distribución</th>
                            <th>Devolución</th>
                            <th>Total</th>
                ...
                <!-- <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 order-lg-2 order-xl-1">
                            <div class="card">
                                <div class="card-body">
                                    <h2 id="seguimiento_header" class="header-title mt-2">Dashboard </h2>
    ...
    <!--pdf-->
    <!-- funciones -->
    <script src="Procesos/js/dashboard.js"></script>
