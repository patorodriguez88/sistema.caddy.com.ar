                    ...
                    <div class="container-fluid" >
                     <div class="row">
                      <div class="col-xl-12 col-lg-12 order-lg-2 order-xl-1">
                        <div class="card">
                            <div class="card-body">
                             <h4 id="seguimiento_header" class="header-title mt-2">GUIAS REDESPACHADAS </h4>
                              <table class="table table-striped table-centered mb-0" id="seguimiento" style="font-size:12px">
                                     <thead>
                                        <tr>
                                            ...
                                            <th>Rec.Caddy</th>
                                            <th>Serv.Caddy</th>
                                            <th>Rec.Redespacho</th>
                                            <th>Serv.Redespacho</th>
                                            <!-- <th>Accion</th> -->
                                        </tr>
                                    </thead>
                                    <tbody>
...
<!--         <script src="https://cdn.datatables.net/select/1.3.3/js/dataTables.select.min.js"></script> -->
        ...
        <!-- end demo js-->
        <!-- funciones -->
        <script src="Procesos/js/redespachos.js"></script>
