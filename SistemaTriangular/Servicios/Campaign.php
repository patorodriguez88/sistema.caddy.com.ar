...
<!DOCTYPE html>
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Sistema Caddy | Campañas</title>
                    ...
                    <div class="container-fluid" >
                     <div class="row">
                      <div class="col-xl-12 col-lg-12 order-lg-2 order-xl-1">
                        <div class="card">
                            <div class="card-body">
                             <h2 id="seguimiento_header" class="header-title mt-2 right"> CADDY CAMPAÑAS </h2>
                                <p class="text-muted font-14">
                                Consideramos <b>Campañas</b> a todos los grupos de envios del mismo origen, mismo numero de venta y mayor de 50 envíos.
                                </p>
