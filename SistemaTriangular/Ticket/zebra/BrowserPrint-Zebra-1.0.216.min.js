...
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(e, h, g) {
...
$jscomp.polyfill = function(e, h, g, l) {
  if (h) {
    ...
    l = g[e];
    h = h(l);
    h != l && null != h && $jscomp.defineProperty(g, e, {
      configurable: !0,
      writable: !0,
      value: h
    })
...
$jscomp.polyfill("Promise", function(e) {
  ...
  function g(b) {
    return b instanceof c ? b : new c(function(a, f) {
      a(b)
    })
  }
  ...
  c.prototype.callWhenSettled_ = function(b, a) {
    ...
    var k = this;
    null == this.onSettledCallbacks_ ? d.asyncExecute(f) : this.onSettledCallbacks_.push(function() {
      d.asyncExecute(f)
    })
  };
  c.resolve = g;
  ...
  c.all = function(b) {
    var a = $jscomp.makeIterator(b),
      f = a.next();
    return f.done ? g([]) : new c(function(b, d) {
      function k(a) {
        return function(f) {
          c[a] = f;
          e--;
      ...
      var c = [],
        e = 0;
      do c.push(void 0), e++, g(f.value).callWhenSettled_(k(c.length - 1), d), f = a.next(); while (!f.done)
    })
  };
  return c
}, "es6", "es3");
