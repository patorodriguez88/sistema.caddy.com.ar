...
$jscomp.checkStringArgs = function(b, h, c) {
  ...
  if (h instanceof RegExp) throw new TypeError("First argument to String.prototype." + c + " must not be a regular expression");
  return b + ""
};
$jscomp.ASSUME_ES5 = !1;
$jscomp.ASSUME_NO_NATIVE_MAP = !1;
$jscomp.ASSUME_NO_NATIVE_SET = !1;
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(b, h, c) {
...
$jscomp.polyfill = function(b, h, c, e) {
  if (h) {
    ...
    e = c[b];
    h = h(e);
    h != e && null != h && $jscomp.defineProperty(c, b, {
      configurable: !0,
      writable: !0,
      value: h
    })
