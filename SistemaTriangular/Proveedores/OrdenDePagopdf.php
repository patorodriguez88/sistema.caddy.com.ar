...
// 	$fecha=date('d/m/Y');
	...
	$this->Text(80,44,'ORDEN DE PAGO',0,'C', 0);
...
$NumeroRepo=$_GET['NR'];
	...
	$pdf->Ln(-23);
 	$pdf->Line(20, 149, 190, 149);  //Horizontal forma de pago
...
// 	$pdf->Cell(0,6,'Domicilio: '.$fila['DomicilioOrigen'],0,1); 
// 	$pdf->Cell(0,6,'Situacion Fiscal: '.$fila['SituacionFiscalOrigen'],0,1); 
...
//   $pdf->Line(20, 38, 190, 38);  //Horizontal
 	$pdf->Line(20, 53, 190, 53);  //Horizontal Datos Clientes
