...
//
// Motivo: Sistema de compras viejo, reemplazado por Proveedores.php > Ingresar Comprobante; usa mysql_query().
//
...
// disponible en el historial de git ("git log -- Proveedores/Compras.php").
// ============================================================
