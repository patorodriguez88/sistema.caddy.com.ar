...
<head>
    <meta charset="utf-8" />
    <title>Sistema Caddy | Proveedores</title>
                ...
                <div class="container-fluid">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="col-12">
                                    <div class="text-end mt-xl-0 mt-2">
                                        <button type="button" class="btn btn-light mb-2 me-2" data-bs-dismiss="modal"> Cancelar</button>
                                        <button id="standard-modal_btn_ok" type="button" class="btn btn-success mb-2 me-2" data-bs-dismiss="modal">Aceptar</button>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                                    ...
                                    <div class="modal-body">
                                            ...
                                            <div class="row">
                                                <div class="col-12 mt-3 mt-sm-0">
                                                    <div class="text-end mt-3 mt-sm-0">
                                                        ...
                                                        <p><b>Total Anticipos: </b> <span class="text-end ml-3" id="footer_total_anticipos"> </span> </p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12 mt-3" id="total">
                                            ...
                                            <div class="row">
                                                <div class="col-12 mt-3 mt-sm-0">
                                                    <div class="text-end mt-3 mt-sm-0">
                                                        <p><b>Total Comprobantes: </b> <span class="text-end ml-3" id="footer_total"> </span> </p>
                                                        <input type="hidden" id="footer_total_input">
                                                        <input type="hidden" id="footer_total_saldo">
                                                        <p><b>Saldo: </b> <span class="text-end ml-3" id="footer_saldo"> </span> </p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                        ...
                                        <form id="CargarPago" name='CargarPago' class='form-group' action='' method='POST'>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 mt-3" id='TercerosOculto' style='display:none;'>
                                                    ...
                                                    <select id='tercero_t' name='tercero_t' onchange='buscardatos(this.value)' class="form-control select3" data-bs-toggle="select3">
                                            ...
                                            <div class="row">
                                                <div class="col-12 mt-1">
                                                    <div class="text-end">
                                                        <p><b>Forma de Pago: </b> <span class="text-end" id="footer_1"> </span> </p>
                                                        <p><b id="footer_2"></b> <span class="text-end" id="footer_2_1"></span></p>
                                                        <p><b id="footer_3"></b> <span class="text-end" id="footer_3_1"></span></p>
                                                        <h3>
                                            ...
                                            <div class="modal-footer">
                                                <!-- <div class="form-group"> -->
                                                <button type="button" class="btn btn-danger" id="cargar_pago_btn_cnl" data-bs-dismiss="modal">Cancelar</button>
                        ...
                        <div class="modal fade" id="modal_cargar_factura" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div id="header-modal" class="modal-header bg-success">

                                        <h4 class="modal-title mr-5 text-white" id="myLargeModalLabel"> Ingresar Comprobante </h4>

                                        <!-- <div class="text-end text-white"> -->
                                        <h5 class="modal-title mr-5 text-white" id="myLargeModalLabel"> Razon Social </h5>
                                        <h6 class="modal-title mr-5 text-white" id="myLargeModalLabel"> Cuit </h6>
                                        <!-- </div> -->
                                    ...
                                    <div class="modal-body">
                                        <!-- action='subir.php' -->
                                        <form id="CargarFactura" name='CargarFactura' class='form-group' method='POST' enctype='multipart/form-data'>

                                            <div class="row">
                                                <div class="col-lg-3 mb-3">
                                                    <div class="form-group">
                                                        <label for="fecha_t">Fecha del Comprobante:</label>
                                                        <input name="fecha_t" type="date" id="fecha_t" class="form-control" required>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 mb-3" id="imp_neto_0">
                                                    <div class="form-group">
                                                        <label for="importeneto_t">Importe Neto</label>
                                                        <input type="number" id="importeneto_t" name="importeneto_t" class="form-control" value='0' onblur="sumar();comprobar()">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4 mb-3" id="solicita_vehiculo" style="display:none">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-lg-4 mb-3" id="solicita_combustible" style="display:none">
                                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group text-end">
                                                        <label>Total:</label>
                                                        <input name='total_t' id='total_t' type="text" class="form-control" data-bs-toggle="input-mask" data-mask-format="#,##0.00" data-reverse="true" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div id='codigodeaprobacion' class="col-lg-4 mb-3" style='display:none'>
                                                    <div class="form-group">
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-2">
                                            <div class="col-sm-5" id="editor">
                                                ...
                                                <select id="buscarproveedor" class="form-control select2" data-bs-toggle="select2">
                                                    <option>Seleccionar Proveedor</option>
                                                </select>
                                                <!-- <div class="text-end mt-xl-0 mt-2">
                                                    <button id="agregar_botton" type="button" class="btn btn-warning"><i class="mdi mdi-rocket me-1"></i> <span>Agregar Proveedor</span></button>
                                                </div>-->
                                            </div>
                                            <!-- Botón alineado a la derecha -->
                                            <div class="col-sm-12 text-end">
                                                <button id="agregar_botton" type="button" class="btn btn-warning">
                                                    <i class="mdi mdi-rocket me-1"></i> <span>Agregar Proveedor</span>
                                                </button>
                                            </div>

                                            <div class="btn-group text-end" id="botonera" style="display:none">
                                        ...
                                        <ul class="nav nav-pills bg-nav-pills nav-justified mb-3" id="steps" style="display:none">
                                            <li class="nav-item">
                                                <a href="#dashboard-information" data-bs-toggle="tab" aria-expanded="true" class="nav-link rounded-0 active">
                                                    <i class="mdi mdi-truck-fast font-18"></i>
                                                    <span class="d-none d-lg-block">Tablero</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#billing-information" data-bs-toggle="tab" aria-expanded="false" class="nav-link rounded-0">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div class="text-end">
                                                            ...
                                                            <!-- <button id="guardar_botton" type="button" class="btn btn-success">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4 mt-3" id="cuenta_contable_select" style="display:none">
                                                            <div class="form-group">
                                                                ...
                                                                <select id="nueva_cuentaasignada" class="form-control select2" data-bs-toggle="select2">
                                                        ...
                                                        <div class="col-lg-2 mt-3">
                                                            ...
                                                            <select id="asana_gid" class="form-control select2" data-bs-toggle="select2">
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <div class="btn-group text-end">
                                                                <!-- <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#modal_cargar_factura">Large Modal</button>                                                         -->
                                                                <!-- <a class="btn btn-warning text-end ml-1" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#modal_cargar_factura" >Cargar Factura</a> -->
                                                                <!-- <a class="btn btn-success text-end ml-1">Pago a Cuenta</a> -->
                                                                <!--<a class="btn btn-success text-end ml-1">Pagar Factura</a>-->
                                                                <h3 class="header-title mt-1">Saldo Cuenta Corriente: <a class="text-info text-end" id="saldo_ctacte"></a></h3>
                                                            </div>

                                                            <!-- <h4 class="header-title mt-2">Cuenta Corriente Saldo: <a class="text-info text-end" id="saldo_ctacte"></a></h4> -->
