...
// Consulta puntual de una tarea + un story de Asana (revisión pedida por Patricio).
define('ALLOW_NO_SESSION', true);
include_once __DIR__ . "/../../../Conexion/Conexioni.php";

header('Content-Type: application/json; charset=utf-8');

$gid = $_GET['gid'] ?? '1217112614281359';
$storyGid = $_GET['story'] ?? '1218596361159072';
...
$storyUrl = 'https://app.asana.com/api/1.0/stories/' . $storyGid
...
$story = asanaCall($storyUrl, $token);

echo json_encode(['task' => $task, 'story' => $story], JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT);
