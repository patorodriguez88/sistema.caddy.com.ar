...
// Comenta y marca completa la tarea "Corregir visualización de asientos
// contables al imprimir".
...
$informe = file_get_contents(__DIR__ . '/informe_asiento_pdf_20260918.txt');
