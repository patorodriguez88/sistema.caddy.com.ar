...
// Comenta y marca completa la tarea "Habilitar asociación de pagos con
// facturas de proveedores" (ya resuelto, commit f69b8933).
define('ALLOW_NO_SESSION', true);
include_once __DIR__ . "/../../../Conexion/Conexioni.php";

header('Content-Type: application/json; charset=utf-8');

$gid = '1218536231905394';
$informe = file_get_contents(__DIR__ . '/informe_asociar_pago_20260918.txt');
