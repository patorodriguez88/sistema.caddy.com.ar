    ...
    <div class="wrapper">
        <div class="content-page">
            <div class="content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 offset-sm-2">
                                            <div class="mt-3 float-sm-right">
                                                ...
                                                <p class="font-13"><strong>Orden Status: </strong> <span class="badge bg-success float-right"> &nbsp; Pendiente</span></p>
                ...
                <!-- Modal -->
                <div id="multiple-two" class="modal fade" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="multiple-twoModalLabel">Agregar Vehículo</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <form id="form_multiple-two" class="p-2">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="task-title" class="form-label">Marca</label>
                                                <input type="text" class="form-control" id="ext_marca" placeholder="Marca">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="task-title" class="form-label">Modelo</label>
                                                <input type="text" class="form-control" id="ext_modelo" placeholder="Modelo">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row g-3">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="task-title" class="form-label">Dominio</label>
                                                <input type="text" class="form-control" id="ext_dominio" placeholder="Dominio">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="task-title" class="form-label">Año</label>
                                                <input type="text" class="form-control" id="ext_ano" placeholder="Año">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="task-title" class="form-label">Color</label>
                                                <input type="text" class="form-control" id="ext_color" placeholder="Color">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="task-title" class="form-label">Kilómetros</label>
                                                <input type="text" class="form-control" id="ext_km" placeholder="Kilómetros">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="task-title" class="form-label">Número de Motor</label>
                                                <input type="text" class="form-control" id="ext_motor" placeholder="Número de Motor">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="task-title" class="form-label">Número de Chasis</label>
                                                <input type="text" class="form-control" id="ext_chassis" placeholder="Número de Chassis">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="task-title" class="form-label">Seguro</label>
                                                <input type="text" class="form-control" id="ext_seguro" placeholder="Seguro">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="task-title" class="form-label">Número de Póliza</label>
                                                <input type="text" class="form-control" id="ext_poliza" placeholder="Número de Póliza">
                                            </div>
                                        </div>

                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="task-title" class="form-label">Vencimiento Seguro</label>
                                                <input type="text" class="form-control" id="ext_seguro_vencimiento" data-bs-toggle="datepicker" data-bs-single-date-picker="true" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row g-3">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="task-title" class="form-label">Volúmen de Carga</label>
                                                <input type="text" class="form-control" id="ext_volumen" placeholder="Máximo de volumen de carga">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="task-title" class="form-label">Peso de Carga</label>
                                                <input type="text" class="form-control" id="ext_peso" placeholder="Máximo de peso de carga">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="task-title" class="form-label">Oblea ITV</label>
                                                <input type="text" class="form-control" id="ext_itv_oblea" placeholder="Número de Oblea ITV">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="task-title" class="form-label">Vencimiento ITV</label>
                                                <input type="text" class="form-control" id="ext_itv_vencimiento" data-bs-toggle="datepicker" data-bs-single-date-picker="true" required>
                                            </div>
                                        </div>
