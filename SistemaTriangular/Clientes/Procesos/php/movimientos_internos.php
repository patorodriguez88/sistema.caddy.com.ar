...
if (isset($_POST['MovimientosInternos_agregar'])) {
    ...
    $query = "INSERT INTO Ctasctes (Fecha,TipoDeComprobante,NumeroVenta,Facturado,RazonSocial,idCliente,Cuit,Debe,Usuario,Comentario) VALUES ('{$Fecha}','MOVIMIENTO INTERNO','{$Num}','1','{$RazonSocial}','{$id_cliente}','{$Cuit}','{$Debe}','{$Usuario}','{$Obs}')";
