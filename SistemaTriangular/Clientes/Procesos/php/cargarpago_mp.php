...
// FIX (2026-09-22, auditoria): claves de array sin comillas ($_POST[x],
// $row[x], etc.) son constantes bareword indefinidas en PHP8 -> Error
// fatal "Undefined constant" en la primera linea de este archivo, todo el
// endpoint (pago por transferencia MP) fallaba siempre. Se cita todo.
// Ademas intval (no trim): MAX()/Max() da NULL si no hay ninguna fila
// todavia, y trim(null)+1 tira TypeError en PHP8.
