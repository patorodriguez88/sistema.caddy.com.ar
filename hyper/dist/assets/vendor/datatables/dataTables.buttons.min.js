...
!(function (e) {
  ...
  function A(n, t) {
    ...
    if (!(this instanceof A))
      return function (t) {
        return new A(t, n).container();
      };
    !0 === (t = void 0 === t ? {} : t) && (t = {}),
      Array.isArray(t) && (t = { buttons: t }),
      (this.c = x.extend(!0, {}, A.defaults, t)),
  ...
  x.extend(A.prototype, {
    ...
    disable: function (t) {
      t = this._nodeToButton(t);
      return (
        (t.isSplit ? x(t.node.childNodes[0]) : x(t.node))
    ...
    enable: function (t, n) {
      return !1 === n
        ? this.disable(t)
        : (((n = this._nodeToButton(t)).isSplit
            ? x(n.node.childNodes[0])
            : x(n.node)
          )
    ...
    remove: function (t) {
      ...
      (n.conf.destroying = !0),
        ...
        x(n.node).remove(),
        n.inserter && x(n.inserter).remove();
      o = x.inArray(n, e);
    ...
    _constructor: function () {
      ...
      t.on("destroy", function (t, n) {
        ...
        x("body").on("keyup." + this.s.namespace, function (t) {
          var n;
          (v.activeElement && v.activeElement !== v.body) ||
    ...
    _expandButton: function (t, n, e, o, i, s, r) {
      for (
        ...
        if (p)
          if (((a = !(!p.config || !p.config.split)), Array.isArray(p)))
            this._expandButton(
              t,
              p,
      ...
      var h,
        ...
        y =
          ...
          e &&
            ...
            this._addKey(g),
            (m = function (t, n, e, o) {
              _.split.action.call(n.button(b), t, n, e, o),
                x(n.table().node()).triggerHandler("buttons-action.dt", [
                  n.button(e),
                  n,
                  e,
            ...
            (v = x(
              ...
              .on("click.dtb", function (t) {
                t.preventDefault(),
                  t.stopPropagation(),
                  v.hasClass(p.disabled) || m(t, f, v, g),
                  l && v.trigger("blur");
              })
              .on("keypress.dtb", function (t) {
                13 === t.keyCode &&
                  (t.preventDefault(), v.hasClass(p.disabled) || m(t, f, v, g));
              })),
            0 === n.split.length && v.addClass("dtb-hide-drop"),
            b.append(v).attr(g.attr)),
          (e ? b : c).get(0));
      return {
        conf: n,
        node: y,
        nodeChild: y && y.children && y.children.length ? y.children[0] : null,
        inserter: e ? b : d,
        buttons: [],
        inCollection: t,
        isSplit: e,
    ...
    _checkSplitEnable: function (t) {
      t = t || this.s.buttons;
      for (var n = 0; n < t.length; n++) {
        var e,
          o = t[n];
        o.isSplit
          ? ((e = o.node.childNodes[1]),
            (this._checkAnyEnabled(o.buttons)
              ? x(e).removeClass(this.c.dom.button.disabled)
              : x(e).addClass(this.c.dom.button.disabled)
            ).prop("disabled", !1))
          : o.isCollection && this._checkSplitEnable(o.buttons);
      }
    },
    _checkAnyEnabled: function (t) {
      for (var n = 0; n < t.length; n++) if (!t[n].disabled) return !0;
      return !1;
    },
    _nodeToButton: function (t, n) {
      for (var e = 0, o = (n = n || this.s.buttons).length; e < o; e++) {
        if (n[e].node === t || n[e].nodeChild === t) return n[e];
    ...
    _resolveExtends: function (e) {
      ...
      for (e = t(e); e && e.extend; ) {
        ...
        void 0 !== e.config &&
          void 0 !== r.config &&
          (e.config = x.extend({}, r.config, e.config)),
          (e = x.extend({}, r, e)),
    ...
    _popover: function (o, t, n) {
      function i() {
        (p = !0),
          w(x(b), h.fade, function () {
            x(this).detach();
          }),
          x(
            d.buttons('[aria-haspopup="dialog"][aria-expanded="true"]').nodes()
          ).attr("aria-expanded", "false"),
          x("div.dt-button-background").off("click.dtb-collection"),
          A.background(!1, h.backgroundClassName, h.fade, g),
          x(m).off("resize.resize.dtb-collection"),
          x("body").off(".dtb-collection"),
          d.off("buttons-action.b-internal"),
          d.off("destroy"),
          x("body").trigger("buttons-popover-hide.dt");
      }
      var e,
        s,
        r,
        ...
        h = x.extend(
          {
            ...
            closeButton: !0,
            containerClassName: f.dom.collection.container.className,
            contentClassName: f.dom.collection.container.content.className,
            collectionLayout: "",
            collectionTitle: "",
            dropup: !1,
            fade: 400,
            ...
            tag: f.dom.collection.container.tag,
          },
          n
        ),
        b = h.tag + "." + h.containerClassName.replace(/ /g, "."),
        f = t.node(),
        g = h.collectionLayout.includes("fixed") ? x("body") : t.node();
      !1 === o
        ? i()
        : ((n = x(
            d.buttons('[aria-haspopup="dialog"][aria-expanded="true"]').nodes()
          )).length && (g.closest(b).length && (g = n.eq(0)), i()),
          h.sort &&
            ((n = x("button", o)
              .map(function (t, n) {
                return { text: x(n).text(), el: n };
              })
              .toArray()).sort(function (t, n) {
              return t.text.localeCompare(n.text);
            }),
            x(o).append(
              n.map(function (t) {
                return t.el;
          ...
          3 === n
            ...
            : 1 === n && (a = "dtb-b1"),
          (e = x("<" + h.tag + "/>")
            .addClass(h.containerClassName)
            .addClass(h.collectionLayout)
            .addClass(h.splitAlignClass)
            .addClass(a)
            .css("display", "none")
            .attr({ "aria-modal": !0, role: "dialog" })),
          (o = x(o)
            .addClass(h.contentClassName)
            .attr("role", "menu")
            .appendTo(e)),
          f.attr("aria-expanded", "true"),
          g.parents("body")[0] !== v.body &&
            (g = x(v.body).children("div, section, p").last()),
          h.popoverTitle
            ? e.prepend(
          ...
          y(e.insertAfter(g), h.fade),
          (n = x(t.table().container())),
          (a = e.css("position")),
          ("container" !== h.span && "dt-container" !== h.align) ||
            ((g = g.parent()), e.css("width", n.width())),
          "absolute" === a
            ? ((f = x(g[0].offsetParent)),
              (t = g.position()),
              (n = g.offset()),
              (a = f.offset()),
              (s = f.position()),
              (r = m.getComputedStyle(f[0])),
              (a.height = f.outerHeight()),
              (a.width = f.width() + parseFloat(r.paddingLeft)),
              (a.right = a.left + a.width),
              (a.bottom = a.top + a.height),
              (a = t.top + g.outerHeight()),
              (l = t.left),
              e.css({ top: a, left: l }),
              (r = m.getComputedStyle(e[0])),
              ((c = e.offset()).height = e.outerHeight()),
              (c.width = e.outerWidth()),
              (c.right = c.left + c.width),
              (c.bottom = c.top + c.height),
              (c.marginTop = parseFloat(r.marginTop)),
              (c.marginBottom = parseFloat(r.marginBottom)),
              h.dropup && (a = t.top - c.height - c.marginTop - c.marginBottom),
              ("button-right" !== h.align &&
                !e.hasClass(h.rightAlignClassName)) ||
                (l = t.left - c.width + g.outerWidth()),
              ("dt-container" !== h.align && "container" !== h.align) ||
                (l < t.left && (l = -t.left)),
              s.left + l + c.width > x(m).width() &&
                (l = x(m).width() - c.width - s.left),
              n.left + l < 0 && (l = -n.left),
              s.top + a + c.height > x(m).height() + x(m).scrollTop() &&
                (a = t.top - c.height - c.marginTop - c.marginBottom),
              f.offset().top + a < x(m).scrollTop() &&
                (a = t.top + g.outerHeight()),
              e.css({ top: a, left: l }))
            : ((u = function () {
                var t = x(m).height() / 2,
              ...
              x(m).on("resize.dtb-collection", function () {
                u();
              })),
          h.background &&
            A.background(
              !0,
              h.backgroundClassName,
              h.fade,
              h.backgroundHost || g
            ),
          ...
          h.autoClose &&
            setTimeout(function () {
              d.on("buttons-action.b-internal", function (t, n, e, o) {
                o[0] !== g[0] && i();
              });
            }, 0),
    ...
    (A.background = function (t, n, e, o) {
      void 0 === e && (e = 400),
        (o = o || v.body),
        t
          ? y(x("<div/>").addClass(n).css("display", "none").insertAfter(o), e)
          : w(x("div." + n), e, function () {
              x(this).removeClass(n).remove();
            });
    }),
    (A.instanceSelector = function (t, s) {
      var r, a, l;
      return null == t
        ? x.map(s, function (t) {
            return t.inst;
        ...
        : ((r = []),
          (a = x.map(s, function (t) {
            return t.name;
          })),
          (l = function (t) {
            var n;
            if (Array.isArray(t))
              for (var e = 0, o = t.length; e < o; e++) l(t[e]);
            else if ("string" == typeof t)
              -1 !== t.indexOf(",")
                ? l(t.split(","))
                : -1 !== (n = x.inArray(t.trim(), a)) && r.push(s[n].inst);
            else if ("number" == typeof t) r.push(s[t].inst);
            else if ("object" == typeof t && t.nodeName)
              for (var i = 0; i < s.length; i++)
                s[i].inst.dom.container[0] === t && r.push(s[i].inst);
            else "object" == typeof t && r.push(t);
          })(t),
          r);
    }),
    (A.buttonSelector = function (t, n) {
      for (
        var c = [],
          u = function (t, n, e) {
          ...
          d = function (t, n) {
            ...
            if (Array.isArray(t) || t instanceof x)
              ...
              if (-1 !== t.indexOf(","))
                ...
                c.push({ inst: n, node: e[x.inArray(t, a)].node });
    ...
    (A.stripData = function (t, n) {
      return (
        "string" ==
          typeof (t =
            null !== t && "object" == typeof t && t.nodeName && t.nodeType
              ? t.innerHTML
              : t) &&
          ((t = A.stripHtmlScript(t)),
          (t = A.stripHtmlComments(t)),
          (n && !n.stripHtml) || (t = e.util.stripHtml(t)),
          (n && !n.trim) || (t = t.trim()),
          (n && !n.stripNewlines) || (t = t.replace(/\n/g, " ")),
          (n && !n.decodeEntities) ||
            (t = i ? i(t) : ((c.innerHTML = t), c.value)),
          !n || n.escapeExcelFormula) &&
          t.match(/^[=+\-@\t\r]/) &&
          (console.log("matching and updateing"), (t = "'" + t)),
        t
      );
    }),
    (A.entityDecoder = function (t) {
      i = t;
    }),
    (A.stripHtmlComments = function (t) {
      for (
        var n;
        (t = (n = t).replace(
          /(<!--.*?--!?>)|(<!--[\S\s]+?--!?>)|(<!--[\S\s]*?$)/g,
    ...
    e.Api.register("buttons()", function (n, e) {
      ...
      var t = this.iterator(
        ...
        function (t) {
          if (t._buttons)
            return A.buttonSelector(A.instanceSelector(n, t._buttons), e);
        },
        !0
      );
    ...
    e.Api.register("buttons().containers()", function () {
      ...
      return (
        this.iterator(!0, "table", function (t) {
          if (t._buttons)
            for (
              var n = A.instanceSelector(s, t._buttons), e = 0, o = n.length;
              e < o;
              e++
            )
    ...
    e.Api.register("button().add()", function (t, n, e) {
      ...
      return (
        o.length &&
          (o = A.instanceSelector(this._groupSelector, o[0]._buttons)).length &&
          o[0].add(n, t, e),
      ...
      return (
        !1 === t
          ? (this.off("destroy.btn-info"),
            w(x("#datatables_buttons_info"), 400, function () {
              x(this).remove();
            }),
            clearTimeout(s),
            (s = null))
  ...
  var s,
    n = function (t, n) {
      ...
      return null ==
        ...
        : (e = (e =
            -1 !== e.indexOf("*")
              ? e.replace(/\*/g, x("head > title").text()).trim()
    ...
    a = function (t, n) {
      ...
      return null === t
        ? null
        : -1 !== t.indexOf("*")
        ? t.replace(/\*/g, x("head > title").text() || "Exported data")
        : t;
    },
    l = function (t, n, e, o) {
      e = r(e, n, t);
    ...
    u = function (i, t) {
      for (
            ...
            ? i
                ...
                .map(function (t) {
                  ...
                  return (
                    e &&
                      (o = (
                        (n = x(".dt-column-title", e)).length ? n : x(e)
                      ).html()),
                ...
                .toArray()
            : null,
          e = x.extend({}, s.modifier),
          o =
            (i.select &&
              "function" == typeof i.select.info &&
              void 0 === e.selected &&
              i.rows(s.rows, x.extend({ selected: !0 }, e)).any() &&
              x.extend(e, { selected: !0 }),
            i.rows(s.rows, e).indexes().toArray()),
          o = i.cells(o, s.columns, { order: e.order }),
          r = o.render(s.orthogonal).toArray(),
          a = o.nodes().toArray(),
          l = o.indexes().toArray(),
          c = i.columns(s.columns).count(),
          u = [],
          d = 0,
          f = 0,
          p = 0 < c ? r.length / c : 0;
        ...
        for (var h = [c], b = 0; b < c; b++)
          (h[b] = s.format.body(r[d], l[d].row, l[d].column, a[d])), d++;
        u[f] = h;
      }
      e = {
        header: t,
        headerStructure: g(
          s.format.header,
          i.table().header.structure(s.columns)
        ),
        footer: n,
        footerStructure: g(
          s.format.footer,
          i.table().footer.structure(s.columns)
        ),
        body: u,
      };
  ...
  return (
    (x.fn.dataTable.Buttons = A),
    (x.fn.DataTable.Buttons = A),
    x(v).on("init.dt plugin-init.dt", function (t, n) {
      "dt" === t.namespace &&
