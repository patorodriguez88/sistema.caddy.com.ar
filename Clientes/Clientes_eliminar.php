                          ...
                          <div class="col-sm-12">
                            <h4 class="mt-2">Datos del Cliente</h4>
                               <ul class="nav nav-tabs nav-bordered mb-3">
                                  ...
                                  <li class="nav-item">
                                      <a href="#webhook" data-toggle="tab" aria-expanded="false" class="nav-link">
                                          <i class="mdi mdi-account-circle d-md-none d-block"></i>
                                          <span id="perfil_webhook"class="d-none d-md-block">Webhook</span>
                                      </a>
                                  </li>
                                  <li class="nav-item">
                                      <a href="#integraciones" data-toggle="tab" aria-expanded="false" class="nav-link">
                                          <i class="mdi mdi-account-circle d-md-none d-block"></i>
                                          <span id="perfil_integracioes" class="d-none d-md-block">Integraciones</span>
                                      </a>
                                  </li>
                                  <li class="nav-item">
                                      <a href="#sure" data-toggle="tab" aria-expanded="false" class="nav-link">
                                          <i class="mdi mdi-account-circle d-md-none d-block"></i>
                             ...
                             <div class="tab-pane" id="recorridos">
                               ...
                               <div class="d-print-none mt-4">
                                        <div class="btn-group float-right">                                        
                                          <a id="Modificar_recorrido_boton" type="button" class="btn btn-primary ml-1" data-toggle="modal" data-target="#modificar_recorridos_modal"  ><i class="mdi mdi-account-cash-outline mr-1"></i>Modificar Valores</a>                                        
                                          <a id="ingresar_recorridos" type="button" class="btn btn-primary ml-1" data-toggle="modal" data-target="#bs-example-modal-lg"><i class="mdi mdi-cart-plus mr-1 ml-1"></i>Ingresar Recorridos</a>
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-sm-6">
                                    <div class="float-right mt-3 mt-sm-0">
                                      ...
                                      <p>
                                        <h4><b>Total Comprobante:  </b><span id="factura_total_detalle"></h4></p>
