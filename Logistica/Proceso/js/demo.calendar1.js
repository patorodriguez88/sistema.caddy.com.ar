$(document).ready(function(){
        var calendar = $('#calendar').fullCalendar({  // assign calendar
            ...
            eventClick:  function(event, jsEvent, view) {  // when some one click on any event
                endtime = new FullCalendar.Calendar.moment(event.end).format('h:mm');
                starttime = new FullCalendar.Calendar.moment(event.start).format('dddd, MMMM Do YYYY, h:mm');
            ...
            select: function(start, end, jsEvent) {  // click on empty time slot
                endtime = new FullCalendar.Calendar.moment(end).format('h:mm');
                starttime = new FullCalendar.Calendar.moment(start).format('dddd, MMMM Do YYYY, h:mm');
                var mywhen = starttime + ' - ' + endtime;
