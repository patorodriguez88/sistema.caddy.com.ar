...
$query="SELECT * FROM HojaDeRuta WHERE Recorrido='$Recorrido' AND Estado='Abierto' ORDER BY Posicion ";
...
//             var nuevodato + 'dato' + i;
//             var dato = route.legs[i].duration.text;  

//               window.location.href = "http://www.triangularlogistica.com.ar/SistemaTriangular/Logistica/CalculaTiempos2.php?viajar=si&" 
//       + nuevodato + "=" + dato;
